...
describe("formatItems", function() {
  ...
  it('["ITEM0001 x 1", "ITEM0013 x 2", "ITEM0022 x 1"] should be formatted', function () {
...
//
//   it("should count each item`s discount", function () {
//     let input = [
//       {
//         id: "ITEM0001",
//         amount: 1,
...
//       }
//     ];
//     let output = discountItems(addedItems, allPromotions);
//     expect(output).toEqual(expected);
//   })
//
// });
